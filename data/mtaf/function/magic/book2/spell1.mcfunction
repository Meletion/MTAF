...
execute if score @s BlazePowderCount matches 0 run return run title @s actionbar "Not Enough Blaze Powder (needs 1)"
execute if score @s XPPoints matches ..9 run return run title @s actionbar "Not Enough XP (needs 10)"
