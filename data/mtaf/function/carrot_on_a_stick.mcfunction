...
execute as @a store result score @s DragonsBreathCount run clear @s minecraft:dragon_breath 0
...
execute as @a store result score @s sugarCount run clear @s minecraft:sugar 0
